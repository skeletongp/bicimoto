<x-app-layout>
    ...
    <div class=" w-full h-full ">
        <section class="text-gray-600 body-font  overflow-hidden">
            <div class="container px-5 py-24  mx-auto max-w-4xl ">
                    <div class=" flex space-x-4 items-center mb-4 justify-end">
                        ...
                        @endcan
                        <livewire:products.add-chasis :product_id="$product->id" />
                    </div>
