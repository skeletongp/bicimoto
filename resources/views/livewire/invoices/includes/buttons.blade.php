<div class="grid grid-cols-3 gap-4 p-4">
    <div class="w-full h-full flex flex-col items-center font-bold uppercase  justify-center text-center" >
        <x-button class="flex flex-col items-center font-bold uppercase rounded-xl py-4 space-y-2 w-full bg-cyan-600 disabled:bg-gray-200 disabled:text-gray-400" wire:click="trySendInvoice" id="btntrySendInvoice" wire:loading.attr='disabled'>
