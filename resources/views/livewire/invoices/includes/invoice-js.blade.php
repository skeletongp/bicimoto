@push('js')
    <script>
        ...
        function print(creditNote) {
            ...
            conector.setEmphasize(0);
            texto(conector, obj.name ? obj.name.toUpperCase() : obj.client.contact.fullname.toUpperCase());
            conector.feed(1);
            ...
            if (obj.rnc) {
                ...
                texto(conector, obj.client.contact.cedula ? obj.client.contact.cedula : '0000000000')
            }
            ...
            texto(conector, 'TEL: ');
            conector.setEmphasize(0);
            texto(conector, obj.client.contact.phone);
            conector.feed(1);

            conector.setEmphasize(1);
            texto(conector, 'DIR: ');
            conector.setEmphasize(0);
            texto(conector, obj.client.contact.address ? obj.client.contact.address : 'N/D');
            conector.feed(1);
            ...
            if (creditNote) {
                ...
                texto(conector, obj.comprobante ? obj.comprobante.type : 'FACTURA NO APTA PARA CREDITO FISCAL')
            }
            conector.setFontSize(1, 1)
            conector.feed(2);
            /* Fin Tipo */
            ...
            texto(conector, 'FAVOR REVISAR LA MERCANCÍA AL MOMENTO DE \n RECIBIR. NO SE ACEPTAN DEVOLUCIONES \n');
