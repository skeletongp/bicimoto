...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        */
        ...
        $store->image()->create([
            'path' => 'https://res.cloudinary.com/atriontechsd/image/upload/v1657810984/bicimoto/logo/bicimoto_logo_negro_bmw9n8.png',
        ]);
       ...
       /*  $user = $store->users()->create([
        ...
        setContable($client, '101', 'debit', $client->contact->name, $place->id);
    ...
    public function setCounts($place, $provider)
    {
        ...
        setContable($place, '402', 'credit', 'Intereses Generados', $place->id);
