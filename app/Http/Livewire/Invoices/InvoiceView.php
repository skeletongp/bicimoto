...
class InvoiceView extends Component
{
    ...
    {
        $invoice = Invoice::whereId($id)->with('seller','contable','client.contact','details.product.units','details.taxes','details.unit', 'payment','store.image','payments.pdf', 'comprobante','pdf','place.preference','creditnote')->first();
